...
This file is the release gate for the first Mango9 iOS App Store submission.
...
- Sample provisioning QR attachment: `[REQUIRED]`
...
Do not enable MFA, expiring passwords, IP restrictions, or a one-use QR code for
...
>
> Sign in using the supplied Mango9 CRM credentials. Mango9 securely discovers
> the user's assigned CRM environment and provisions the corresponding SIP
> extension. The user can then make and receive business calls, access assigned
> CRM records, and communicate with authorized users in the same Mango9 tenant.
>
> Review steps:
> 1. Launch Mango9 and sign in with the supplied CRM credentials.
...
2. Choose the immutable tag name, such as `ios-6.2.0-build-12`, and change
