...
#   LINPHONE_TEST_DOMAIN     defaults to proxy.mango9.com
...
LINPHONE_TEST_DOMAIN="${CLI_DOMAIN:-${LINPHONE_TEST_DOMAIN:-proxy.mango9.com}}"
...
APP_GROUPS=(
  "group.com.mango9.phone.msgNotification"
  "group.com.mango9.phone.share"
)
